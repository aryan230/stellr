    ...
    <div className="navbar">
      ...
      {userInfo && userInfo.isAdmin && (
        <div
          ...
          className="fixed bottom-10 right-20 w-fit px-5 py-2 bg-indigo-600 rounded-xl hover:cursor-pointer flex items-center justify-center"
        >
          <svg
          ...
          <span className="ml-3 text-white">View Admin Panel</span>
        </div>
      )}
